...
import { IDomainEvent, IAggregateRoot } from '../interfaces';
 ...
 */
@Injectable()
export abstract class DomainEventHandler<TEvent extends IDomainEvent = IDomainEvent>
 ...
 */
@Injectable()
export abstract class ProjectionEventHandler<TEvent extends IDomainEvent = IDomainEvent>
  extends BaseEventHandler<TEvent> {
 ...
 */
@Injectable()
export abstract class IntegrationEventPublisher<TEvent extends IDomainEvent = IDomainEvent>
  extends BaseEventHandler<TEvent> {
